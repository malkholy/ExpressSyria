    ...
    return (
      <div className="login-page">
        <div className="login-card">
          ...
          <div className="login-title">Express Panel</div>
          ...
          <div className="login-api">express-syria.glcpaints.com:7779</div>
        </div>
      </div>
    );
  }
    ...
    <div className={`app${dark ? ' dark' : ''}`}>
      ...
      <aside className={`sidebar${isSidebarCollapsed ? ' collapsed' : ''}`}>
        <div className="sb-head" style={{ display: 'flex', flexDirection: isSidebarCollapsed ? 'column' : 'row', alignItems: 'center', justifyContent: 'space-between', gap: isSidebarCollapsed ? 8 : 0 }}>
          <div className="sb-brand" onClick={() => openPage('client_master')} title="Express Panel">
            <div className="sb-logo">EP</div>
            <div className="sb-brand-text">
              <div className="sb-name">Express Panel</div>
